...
: ${AMENT_CURRENT_PREFIX:="/data/install/qt_image_text_transfer"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/qt_image_text_transfer/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/qt_image_text_transfer/environment/path.sh"
